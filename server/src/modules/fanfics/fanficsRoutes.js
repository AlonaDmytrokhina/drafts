...
import { uploadCover, parseFicData } from "../../middleware/storage.js";

const router = Router();

router.get('/', optionalAuth, fanficsController.findFanfics);
router.get('/:fanficId', optionalAuth, fanficsController.getFanficById);
router.post('/', authMiddleware, uploadCover.single("cover"), parseFicData, fanficsController.createFanfic);
